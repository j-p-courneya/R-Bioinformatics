...
# Instead, please edit 07-Bioconductor.md in _episodes_rmd/
...
**Using the RStudio interface:** 
<img src="../fig/rstudio_loadLib.png" title="plot of chunk unnamed-chunk-4" alt="plot of chunk unnamed-chunk-4" width="60%" style="display: block; margin: auto auto auto 0;" />
...
Once the *[BiocManager](https://bioconductor.org/packages/3.12/BiocManager)* package is installed, the `BiocManager::version()` function displays the version (i.e., release) of the Bioconductor project that is currently active in the R session.
...
Each package hosted on Bioconductor has a dedicated page with various resources. For an example, looking at the *[scater](https://bioconductor.org/packages/3.12/scater)* package page on Bioconductor, we see that it contains:
